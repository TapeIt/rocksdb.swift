...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "librocksdb",
            url: "https://github.com/TapeIt/rocksdb.swift/releases/download/v6.29.5/librocksdb.zip",
            checksum: "e7ac25623a6448aef4bf331e908c620d2c13036aa13f13331fd593504899f0e6"),
        .target(
            name: "RocksDB",
